...
export const Route = createFileRoute("/app/admin/u/$userId")({ component: AdminUserPage });
  ...
  if (!user) {
    return (
      <main className="px-4 pb-28 pt-[calc(env(safe-area-inset-top)+8px)]">
        ...
        <Button className="mt-4" variant="secondary" onClick={() => void navigate({ to: "/app/admin" })}>
          Retour
        </Button>
      </main>
    );
